...
## Step 1:
- First, connect the four wires in the IMU and plug them into these pins: UCC, GND, SCL, and SDA. Make sure you don't tangle them.
- Now the other end of the wires connect it this way:
    - 
