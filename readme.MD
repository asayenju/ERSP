...
- Initialize:
  ...
  - Load SVM model.
  - Set up circular buffer (deque) for sensor data.
- Read Data:
...
- Baud Rate: Must match sender device (e.g., ESP32).

7. Output:
- Prints predicted gesture in real-time:
```
